...
//createThumb("{$pathToImages}{$fname}", $pathToThumbs, $crop_height, $crop_width);
	
function createThumb($file_name, $destination, $crop_height, $crop_width) {	
